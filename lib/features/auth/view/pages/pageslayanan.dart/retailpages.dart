...
class RetailPages extends StatefulWidget {
  RetailPages({super.key});

  @override
  State<RetailPages> createState() => _RetailPagesState();
}

class _RetailPagesState extends State<RetailPages> {
  String? selected;
